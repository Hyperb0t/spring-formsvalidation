...
public class SpringController {
  ...
  public String springHandler(
    ...
    if (result.hasErrors()) {
      BeanPropertyBindingResult r = (BeanPropertyBindingResult) result.getModel().get("org.springframework.validation.BindingResult.author");
      r.getAllErrors().stream().forEach(System.out::println);
      return "author_form";
    } else {
